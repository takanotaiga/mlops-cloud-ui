...
export const SURREAL_CONFIG = {
  ...
  url: process.env.NEXT_PUBLIC_SURREAL_URL ?? "ws://taiga-macmini.local:65303",
  // Namespace and database
  ns: process.env.NEXT_PUBLIC_SURREAL_NS ?? "test",
  db: process.env.NEXT_PUBLIC_SURREAL_DB ?? "test",
